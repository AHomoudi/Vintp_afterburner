...
source("wind_afterburner/wind_afterburner_CanESM2_IPSL-CM5A-MR.R")
...
source("spec_hum_afterburner/spec_hum_afterburner_CanESM2_IPSL-CM5A-MR.R")
...
source("temp_afterburner/temp_afterburner_CanESM2_IPSL-CM5A-MR.R")
...
#=================================END===========================================
#Test
#u_nc.files<-u_nc.files[c(1,6)]
#v_nc.files<- v_nc.files[c(1,6)]
