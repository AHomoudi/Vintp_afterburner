...
Temperature_afterburner<-function(temp_file,surf_gepo,pressure_file,req_press_levels){
  ...
  dyn.load("temp_afterburner/press_calc_HadGEM2-ES.so")
  #check
